define(['exports', 'js/constants'], function (exports, _constants) {
  ...
  var config = exports.config = {
    ...
    shortTermServices: {
      modis24HR: {
        ...
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_24hrs/MapServer', // Staging
        id: 21 // Staging
      },
      modis48HR: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_48hrs/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_48hrs/MapServer', // Staging
        id: 21 // Staging
      },
      modis7D: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_7d/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_7d/MapServer', // Staging
        id: 21 // Staging
      },
      modis1YR: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_1yr/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_1yr/MapServer', // Staging
        id: 21 // Staging
      },
      viirs24HR: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_24hrs/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_24hrs/MapServer', // Staging
        id: 21 // Staging
      },
      viirs48HR: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_48hrs/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_48hrs/MapServer', // Staging
        id: 21 // Staging
      },
      viirs7D: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_7d/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_7d/MapServer', // Staging
        id: 21 // Staging
      },
      viirs1YR: {
        // url: 'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_1yr/MapServer', // Production
        url: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_1yr/MapServer', // Staging
        id: 21 // Staging
      }
    },
    ...
    layers: [{
      ...
      id: _constants2.default.viirsFires48,
      order: 13,
      type: 'feature',
      ...
      id: _constants2.default.viirsFires72,
      order: 13,
      type: 'feature',
      label: 'VIIRS active fires 72',
      visible: false,
      definitionExpression: 'Date > date\'' + new window.Kalendae.moment().subtract(3, 'd').format('YYYY-MM-DD HH:mm:ss'),
      layerIds: [21],
      className: 'viirs-fires',
      // url:
      //   "https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_24hrs/MapServer", // Production
      ...
      id: _constants2.default.viirsFires7D,
      order: 13,
      type: 'feature',
      ...
      id: _constants2.default.viirsFires1Y,
      order: 13,
      type: 'feature',
      ...
      id: _constants2.default.activeFires48,
      order: 12,
      type: 'feature',
      ...
      id: _constants2.default.activeFires72,
      order: 12,
      type: 'feature',
      ...
      id: _constants2.default.activeFires7D,
      order: 12,
      type: 'feature',
      ...
      id: _constants2.default.activeFires1Y,
      order: 12,
      type: 'feature',
    ...
    // },
    {
      ...
      id: _constants2.default.gfedEmissions,
      order: 1,
      type: 'dynamic',
      label: 'Emission 2015',
  ...
  config.text.layerInformation[_constants2.default.treeCoverDensity] = {
    ...
    table: [{ label: 'Function', html: 'Identifies areas of tree cover' }, { label: 'Resolution/Scale', html: '30 × 30 meters' }, {
      label: 'Geographic Coverage',
      html: 'Global land (excluding Antarctica and Arctic islands)'
    }, {
      label: 'Source Data',
      html: '<a href="https://landsat.usgs.gov/" target="_blank">Landsat 7 ETM+</a>'
    }, { label: 'Date of Content', html: '2000' }, {
      label: 'Cautions',
      html: 'For the purpose of this study, “tree cover” was defined as all vegetation taller than 5 meters in height. “Tree cover” is the biophysical presence of trees and may take the form of natural forests or plantations existing over a range of canopy densities.'
    }],
  ...
  config.text.layerInformation[_constants2.default.activeFires] = {
    ...
    table: [{ label: 'Function', html: 'Displays fire alert data for the past 7 days' }, { label: 'Resolution/Scale', html: '1 × 1 kilometer' }, { label: 'Geographic Coverage', html: 'Global' }, {
      label: 'Source Data',
      html: '<a href="https://modis.gsfc.nasa.gov/about/" target="_blank">MODIS</a>'
    ...
    citation: ['<strong>Citation:</strong>NASA FIRMS. “NASA Fire Information for Resource Management System (FIRMS).” Accessed on [date]. <a href="earthdata.nasa.gov/data/near-real-time-data/firms" target="_blank">earthdata.nasa.gov/data/near-real-time-data/firms</a>.', '<strong>Suggested citation for data as displayed on GFW:</strong> “NASA Active Fires.” NASA FIRMS. Accessed through Global Forest Watch on [date]. <a href="https://www.globalforestwatch.org" target="_blank">www.globalforestwatch.org</a>.']
  };
  ...
  config.text.layerInformation[_constants2.default.burnScars] = {
    ...
    }, { label: 'Resolution/Scale', html: '30 meters' }, { label: 'Geographic Coverage', html: 'Sumatra, Indonesia' }, {
      label: 'Source Data',
      html: '<a href="https://landsat.usgs.gov/index.php" target="_blank">Landsat</a>'
    }, { label: 'Date of Content', html: 'May 1, 2014 - present' }, {
      label: 'Cautions',
      html: 'This data layer is provided as a beta analysis product and should be used for visual purposes only.'
    }],
    ...
    citation: ['<strong>Citation:</strong>Elvidge, Christopher D. and Kimberly Baugh. 2014. Burn scar mapping from Landsat 8. Presentation at APAN meeting in Bandung, Indonesia. January 20.', '<strong>URL:</strong><a href="https://www.apan.net/meetings/Bandung2014/Sessions/EM/Elvidge_L8_burnscar_20140120.pdf" target="_blank">https://www.apan.net/meetings/Bandung2014/Sessions/EM/Elvidge_L8_burnscar_20140120.pdf</a>.']
  };
  ...
  config.text.layerInformation[_constants2.default.darkGrayBasemap] = {
    ...
    citation: ['This work is licensed under the Web Services and API Terms of Use. <a href="https://links.esri.com/tou_summary" target="_blank">View Summary</a>  |  <a href="https://links.esri.com/agol_tou" target="_blank">View Terms of Use</a> ']
  };
