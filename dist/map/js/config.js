  ...
  var config = exports.config = {
    ...
    */
    layers: [{
      ...
      id: _constants2.default.viirsFires + '2',
      order: 13,
      type: 'dynamic',
      label: 'VIIRS active fires',
      group: 'fires-hidden',
      ...
      id: _constants2.default.viirsFires + '3',
      order: 13,
      type: 'dynamic',
      label: 'VIIRS active fires',
      group: 'fires-hidden',
      ...
      id: _constants2.default.viirsFires + '7',
      order: 13,
      type: 'dynamic',
      label: 'VIIRS active fires',
      group: 'fires-hidden',
      ...
      id: _constants2.default.activeFires + '2',
      order: 12,
      type: 'dynamic',
      label: 'MODIS active fires',
      group: 'fires-hidden',
      ...
      id: _constants2.default.activeFires + '3',
      order: 12,
      type: 'dynamic',
      label: 'MODIS active fires',
      group: 'fires-hidden',
      ...
      id: _constants2.default.activeFires + '7',
      order: 12,
      type: 'dynamic',
      label: 'MODIS active fires',
      group: 'fires-hidden',
    ...
    text: {
      ...
      layerPanel: {
        ...
        firesOptions: [{ label: 'Past 24 hours', value: 1 }, { label: 'Past 48 hours', value: 2 }, { label: 'Past 72 hours', value: 3 }, { label: 'Past Week', value: 7 }, { label: 'Active Fires', value: 0 }],
