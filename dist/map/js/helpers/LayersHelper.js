  ...
  var LayersHelper = {
    ...
    checkZoomDependentLayers: function checkZoomDependentLayers() {
      ...
      var level = 6,
        ...
        helperLayer = app.map.getLayer(
          _constants2.default.protectedAreasHelper
        );
    ...
    performIdentify: function performIdentify(evt) {
      ...
      if (layer) {
        if (layer.visible) {
          deferreds.push(
            _request2.default.identifyLoggingConcessions(mapPoint)
          );
        }
      }
      ...
      if (layer) {
        if (layer.visible) {
          deferreds.push(
            _request2.default.identifyWoodFiberGreenpeace(mapPoint)
          );
        }
      }
      ...
      var helperLayer = app.map.getLayer(
        _constants2.default.protectedAreasHelper
      );
      ...
      if (layer) {
        if (layer.visible) {
          if (evt.graphic) {
            deferreds.push(
              _request2.default.identifyDigitalGlobe(evt.graphic, mapPoint)
            );
          }
        }
      }
      ...
      if (layer) {
        if (layer.visible) {
          ...
          deferreds.push(
            _request2.default.identifyOverlays(mapPoint, visibleLayers)
          );
        }
      }
      ...
      (0, _all2.default)(deferreds).then(
        function(featureSets) {
            ...
            switch (item.layer) {
              case _constants2.default.activeFires:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.activeFires
                  )
                );
                break;
              case _constants2.default.viirsFires:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.viirsFires
                  )
                );
                break;
              case _constants2.default.archiveFires:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.archiveFires
                  )
                );
                break;
              case _constants2.default.noaa18Fires:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.noaa18Fires
                  )
                );
                break;
              ...
              case _constants2.default.rspoOilPalm:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.rspoOilPalm
                  )
                );
                break;
              ...
              case _constants2.default.gfwLogging:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.gfwLogging
                  )
                );
                break;
              case _constants2.default.loggingConcessions:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.loggingConcessions
                  )
                );
                break;
              case _constants2.default.oilPalmGreenpeace:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.oilPalmGreenpeace
                  )
                );
                break;
              case _constants2.default.woodFiberGreenpeace:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.woodFiberGreenpeace
                  )
                );
                break;
              case _constants2.default.loggingGreenpeace:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.loggingGreenpeace
                  )
                );
                break;
              case _constants2.default.coalConcessions:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.coalConcessions
                  )
                );
                break;
              ...
              case _constants2.default.fireStories:
                features = features.concat(
                  _this.setStoryTemplates(
                    item.features,
                    _constants2.default.fireStories
                  )
                );
              ...
              case _constants2.default.overlays:
                features = features.concat(
                  _this.setActiveTemplates(
                    item.features,
                    _constants2.default.overlays
                  )
                );
                break;
              case _constants2.default.boundingBoxes:
                features = features.concat(
                  _this.setDigitalGlobeTemplates(item.features)
                );
                break;
              default:
                // Do Nothing
          ...
          if (features.length > 0) {
            ...
            (0, _query2.default)(".contentPane .layer-subscribe").forEach(
              function(rowData) {
                subscribeHandles.push(
                  (0, _on2.default)(rowData, "click", function(clickEvt) {
            ...
            (0, _query2.default)(".infoWindow-close").forEach(function(
              rowData
            ) {
              closeHandles.push(
                (0, _on2.default)(rowData, "click", function() {
            ...
            (0, _query2.default)(".contentPane .imagery-data").forEach(function(
              rowData
            ) {
              handles.push(
                (0, _on2.default)(rowData, "click", function(clickEvt) {
                  ...
                  (0, _query2.default)(".contentPane .imagery-data").forEach(
                    function(innerNode) {
                      _domClass2.default.remove(
                  ...
                  _domClass2.default.add(
                    clickEvt.currentTarget.parentElement,
                    "selected"
                  );
    ...
    showDigitalGlobeImagery: function showDigitalGlobeImagery(imageryItem) {
      ...
      var config = _AppUtils2.default.getObject(
        _config.layersConfig,
        "id",
        _constants2.default.digitalGlobe
      );
    ...
    setActiveTemplates: function setActiveTemplates(featureObjects, keyword) {
      ...
      featureObjects.forEach(function(item) {
        var config = _AppUtils2.default.getObject(
          _config.layersConfig,
          "id",
          _constants2.default[keyword]
        );
        var fire_results = "",
          subscribe = "";
        if (
          keyword === _constants2.default.woodFiber ||
          keyword === _constants2.default.gfwLogging ||
          keyword === _constants2.default.oilPalm ||
          keyword === _constants2.default.mining ||
          keyword === _constants2.default.loggingConcessions ||
          keyword === _constants2.default.oilPalmGreenpeace ||
          keyword === _constants2.default.woodFiberGreenpeace ||
          keyword === _constants2.default.loggingGreenpeace ||
          keyword === _constants2.default.coalConcessions
        ) {
          ...
          keyword === _constants2.default.rspoOilPalm ||
          keyword === _constants2.default.protectedAreasHelper
        ) {
          fire_results = _this2.getFirePopupContent(item);
          subscribe =
            '</table><div title="close" class="infoWindow-close close-icon"><svg viewBox="0 0 100 100"><use xlink:href="#shape-close" /></use></svg></div><div class="layer-subscribe-container"><button data-url=' +
          ...
          subscribe =
            '</table><div id="burnScarImagery"><img height="220" width="220" src="https://s3.amazonaws.com/explorationlab/' +
            item.feature.attributes.ChipURL +
            '"></div><div title="close" class="infoWindow-close close-icon"><svg viewBox="0 0 100 100"><use xlink:href="#shape-close" /></use></svg></div>';
          ...
          subscribe =
            '</table><div title="close" class="infoWindow-close close-icon"><svg viewBox="0 0 100 100"><use xlink:href="#shape-close" /></use></svg></div>';
        }
    ...
    setDigitalGlobeTemplates: function setDigitalGlobeTemplates(features) {
      ...
      features.forEach(function(feature) {
        var date = window.Kalendae.moment(
        ...
        htmlContent +=
          ...
          '" data-layer="' +
          feature.attributes.LayerId +
          '" data-bucket="' +
          feature.attributes.SensorName +
          '" class="imagery-data left">' +
          date +
          ' </td><td data-id="' +
          feature.attributes.OBJECTID +
          '" data-layer="' +
    ...
    setStoryTemplates: function setStoryTemplates(features) {
      ...
      features.forEach(function(item) {
        if (app.mobile() === true) {
          htmlContent =
            '<table class="fire-stories-popup mobile"><span class="name-field">' +
            item.feature.attributes.Title +
            '</span></tr><div title="close" class="infoWindow-close close-icon"><svg viewBox="0 0 100 100"><use xlink:href="#shape-close" /></use></svg></div>';
        } else {
          htmlContent =
            '<table class="fire-stories-popup"><span class="name-field">' +
            item.feature.attributes.Title +
            '</span></tr><div title="close" class="infoWindow-close close-icon"><svg viewBox="0 0 100 100"><use xlink:href="#shape-close" /></use></svg></div>';
        }
        if (
    ...
    setCustomFeaturesTemplates: function setCustomFeaturesTemplates(feature) {
      var template = new _InfoTemplate2.default(
        "Custom",
        _config.uploadConfig.infoTemplate.content
      );
    ...
    changeOpacity: function changeOpacity(parameters) {
      ...
      if (layer) {
        ...
        if (
          layer.hasOwnProperty("id") &&
          layer.id === _constants2.default.fireHistory
        ) {
    ...
    showLayer: function showLayer(layerObj) {
      ...
      if (layerObj.layerId === _constants2.default.digitalGlobe) {
        ...
        if (footprints) {
          var footprintsLayer = app.map.getLayer(
            _constants2.default.boundingBoxes
          );
          ...
          _request2.default.getBoundingBoxes().then(function(item) {
            if (item === true) {
              var _footprintsLayer = app.map.getLayer(
                _constants2.default.boundingBoxes
              );
              var tempGraphics = [];
        ...
        layerObj.layerId === _constants2.default.protectedAreas ||
        layerObj.layerId === _constants2.default.protectedAreasHelper
      ) {
        var level = 6,
          mainLayer = app.map.getLayer(_constants2.default.protectedAreas),
          helperLayer = app.map.getLayer(
    ...
    hideLayer: function hideLayer(layerId) {
      ...
      if (layerId === _constants2.default.digitalGlobe) {
        ...
        layerId === _constants2.default.protectedAreas ||
        layerId === _constants2.default.protectedAreasHelper
      ) {
    ...
    getFirePopupContent: function getFirePopupContent(item) {
      ...
      var firesDiv =
        '<div class="fire-popup-list" id="fireResults">RECENT FIRES';
      var noFiresDiv =
        '<div class="fire-popup-list no-fires" id="fireResults">No fires in past 7 days';
      ...
      if (isFires) {
        ...
        fire_results +=
          ...
          '<div id="firesWeek-pop" class="fire-pop-item"><div class="fire-pop-count">' +
          fireCounts[3] +
          '</div><div class="fire-pop-label">Week</div></div>' +
          '<div id="fires72-pop" class="fire-pop-item"><div class="fire-pop-count">' +
          fireCounts[2] +
          '</div><div class="fire-pop-label">72 hrs</div></div>' +
          '<div id="fires48-pop" class="fire-pop-item"><div class="fire-pop-count">' +
          fireCounts[1] +
          '</div><div class="fire-pop-label">48 hrs</div></div>' +
    ...
    updateFiresLayerDefinitions: function updateFiresLayerDefinitions(
      optionIndex
    ) {
      ...
      if (firesLayer) {
        ...
        switch (optionIndex) {
          case 0:
            //past 24 hours
            firesLayer.url = _config.shortTermServices.modis24HR.url;
            firesLayer._url.path = _config.shortTermServices.modis24HR.url;
            firesLayer.setVisibleLayers([
              _config.shortTermServices.modis24HR.id
            ]);
            break;
          case 1:
            //past 48 hours
            firesLayer.url = _config.shortTermServices.modis48HR.url;
            firesLayer._url.path = _config.shortTermServices.modis48HR.url;
            firesLayer.setVisibleLayers([
              _config.shortTermServices.modis48HR.id
            ]);
            break;
          case 2:
            //past 72 hours
            firesLayer.url = _config.shortTermServices.modis7D.url;
            firesLayer._url.path = _config.shortTermServices.modis7D.url;
            firesLayer.setVisibleLayers([_config.shortTermServices.modis7D.id]);
            layaDefs[_config.shortTermServices.modis7D.id] =
              "Date > date'" +
              new window.Kalendae.moment()
                .subtract(3, "d")
      ...
      if (viirs) {
        ...
        switch (optionIndex) {
          case 0:
            ...
            viirs.dynamicLayerInfos[0].id =
              _config.shortTermServices.viirs24HR.id;
            viirs.dynamicLayerInfos[0].source.mapLayerId =
              _config.shortTermServices.viirs24HR.id;
            break;
          case 1:
            //past 48 hours
            ...
            viirs.dynamicLayerInfos[0].id =
              _config.shortTermServices.viirs48HR.id;
            viirs.dynamicLayerInfos[0].source.mapLayerId =
              _config.shortTermServices.viirs48HR.id;
            break;
          case 2:
            ...
            layaDefs[_config.shortTermServices.viirs7D.id] =
              "Date > date'" +
              new window.Kalendae.moment()
                .subtract(3, "d")
                .format("YYYY-MM-DD HH:mm:ss") +
              "'";
            viirs.dynamicLayerInfos[0].id =
              _config.shortTermServices.viirs7D.id;
            viirs.dynamicLayerInfos[0].source.mapLayerId =
              _config.shortTermServices.viirs7D.id;
            break;
          case 3:
    ...
    updatePlantationLayerDefinitions: function updatePlantationLayerDefinitions(
      optionIndex
    ) {
    ...
    updateViirsArchiveDates: function updateViirsArchiveDates(clauseArray) {
      ...
      if (archiveLayer) {
        ...
        archiveLayer.layerDrawingOptions[0] =
          archiveLayer.layerDrawingOptions[
            _config.layersConfig.filter(function(index) {
        ...
        var string =
          ...
          new window.Kalendae.moment(clauseArray[0]).format("M/D/YYYY") +
          "'";
        archiveLayer.dynamicLayerInfos[
          _config.shortTermServices.viirs1YR.id
        ].id = _config.shortTermServices.viirs1YR.id;
        archiveLayer.dynamicLayerInfos[
          _config.shortTermServices.viirs1YR.id
        ].source.mapLayerId = _config.shortTermServices.viirs1YR.id;
        archiveLayer.dynamicLayerInfos[
          _config.shortTermServices.viirs1YR.id
    ...
    updateModisArchiveDates: function updateModisArchiveDates(clauseArray) {
      ...
      var archiveLayer = app.map.getLayer(_constants2.default.activeFires);
      if (archiveLayer) {
        // normally you wouldn't alter the urls for a layer but since we have moved from one behemoth service to 4 different services, we need to modify the layer url and id.
        // We are hiding and showing the layer to avoid calling the service multiple times.
        archiveLayer.hide();
        archiveLayer.url = _config.shortTermServices.modis1YR.url;
        archiveLayer._url.path = _config.shortTermServices.modis1YR.url;
        archiveLayer.setVisibleLayers([_config.shortTermServices.modis1YR.id]);
        var string =
          "ACQ_DATE <= date'" +
          new window.Kalendae.moment(clauseArray[1]).format("M/D/YYYY") +
          "' AND ACQ_DATE >= date'" +
          ...
          "'";
        var layerDefs = [];
        layerDefs[_config.shortTermServices.modis1YR.id] = string;
    ...
    updateNoaaDates: function updateNoaaDates(clauseArray) {
      ...
      if (noaaLayer) {
        var startDate = new window.Kalendae.moment(clauseArray[0]).format(
          "M/D/YYYY"
        );
        var endDate = new window.Kalendae.moment(clauseArray[1])
          .add(1, "day")
          .format("M/D/YYYY");
    ...
    updateDigitalGlobeLayerDefinitions: function updateDigitalGlobeLayerDefinitions(
      clauseArray
    ) {
    ...
    updateTreeCoverDefinitions: function updateTreeCoverDefinitions(
      densityValue
    ) {
      ...
      var layerConfig = _AppUtils2.default.getObject(
        _config.layersConfig,
        "id",
        _constants2.default.treeCoverDensity
      );

      var rasterFunction = _rasterFunctions2.default.getColormapRemap(
        layerConfig.colormap,
        [densityValue, layerConfig.inputRange[1]],
        layerConfig.outputRange
      );
