define(['exports', 'utils/request', 'react'], function (exports, _request, _react) {
  ...
  var AirQualityLegend = function (_React$Component) {
    _inherits(AirQualityLegend, _React$Component);
  ...
  exports.default = AirQualityLegend;
});