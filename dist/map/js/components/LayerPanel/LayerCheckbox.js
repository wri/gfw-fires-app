  ...
  var LayerCheckbox = (function(_React$Component) {
    ...
    function LayerCheckbox(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (LayerCheckbox.__proto__ || Object.getPrototypeOf(LayerCheckbox)).call(
          this,
          props
        )
      );
    ...
    _createClass(LayerCheckbox, [
      ...
      },
      {
        ...
        value: function shouldComponentUpdate(nextProps) {
          return (
            nextProps.checked !== this.props.checked || this.props.children
          );
        }
      },
      {
            ...
            !layer.metadataId
              ...
              : _react2.default.createElement(
                  ...
                  _react2.default.createElement('svg', {
                    dangerouslySetInnerHTML: { __html: useSvg }
                  })
                ),
            !this.props.children
              ? null
              : _react2.default.createElement(
                  'div',
                  {
                    className:
                      ...
                      (this.props.checked || this.props.childrenVisible
                        ? ''
                        : 'hidden')
                  },
                  this.props.children
          ...
          if (this.props.checked) {
            ...
            if (layer.id.includes('activeFires')) {
              var modisLayerIds = [
                ...
                _constants2.default.activeFires48,
                _constants2.default.activeFires72,
                _constants2.default.activeFires7D,
                _constants2.default.activeFires1Y
              ];

              var layerToHide = app.map.getLayer(
              ...
              var viirsLayerIds = [
                ...
                _constants2.default.viirsFires48,
                _constants2.default.viirsFires72,
                _constants2.default.viirsFires7D,
                _constants2.default.viirsFires1Y
              ];
              var _layerToHide = app.map.getLayer(
            ...
            if (layer.id.includes('activeFires')) {
              ...
              var layerToShow = app.map.getLayer(
                _modisLayerIds[this.state.firesSelectIndex]
              );
              if (layerToShow) {
                layerToShow.show();
              }
              ...
              var _layerToShow = app.map.getLayer(
                _viirsLayerIds[this.state.viirsSelectIndex]
              );
              if (_layerToShow) {
                _layerToShow.show();
              }
