define(['exports', 'utils/request', 'react'], function (exports, _request, _react) {
  ...
  var RSPOLegend = function (_React$Component) {
    _inherits(RSPOLegend, _React$Component);

    function RSPOLegend(props) {
      _classCallCheck(this, RSPOLegend);

      var _this = _possibleConstructorReturn(this, (RSPOLegend.__proto__ || Object.getPrototypeOf(RSPOLegend)).call(this, props));

      _this.state = { legendInfos: [] };
      return _this;
    }

    _createClass(RSPOLegend, [{
