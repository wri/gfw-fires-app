define(['exports', 'utils/request', 'react'], function (exports, _request, _react) {
  ...
  var BurnScarsLegend = function (_React$Component) {
    _inherits(BurnScarsLegend, _React$Component);

    function BurnScarsLegend(props) {
      _classCallCheck(this, BurnScarsLegend);

      var _this = _possibleConstructorReturn(this, (BurnScarsLegend.__proto__ || Object.getPrototypeOf(BurnScarsLegend)).call(this, props));

      _this.state = { legendInfos: [] };
      return _this;
    }

    _createClass(BurnScarsLegend, [{
    ...
    return BurnScarsLegend;
  }(_react2.default.Component);

  exports.default = BurnScarsLegend;
});