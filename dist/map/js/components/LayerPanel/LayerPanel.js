define(['exports', 'components/LayerPanel/WaterStressLegend', 'components/LayerPanel/LandCoverLegend', 'components/LayerPanel/RSPOLegend', 'components/LayerPanel/SedimentLegend', 'components/LayerPanel/DensityDisplay', 'components/LayerPanel/LayerCheckbox', 'components/LayerPanel/FiresControls', 'components/LayerPanel/FireHistoryTimeline', 'components/LayerPanel/ForestControls', 'components/LayerPanel/RiskControls', 'components/LayerPanel/PlantationControls', 'components/LayerPanel/ViirsControls', 'components/LayerPanel/ArchiveControls', 'components/LayerPanel/NoaaControls', 'components/LayerPanel/BurnScarsLegend', 'components/LayerPanel/RainControls', 'components/LayerPanel/AirControls', 'components/LayerPanel/WindControls', 'components/LayerPanel/LayerTransparency', 'components/LayerPanel/ImageryComponent', 'components/LayerPanel/LayerGroup', 'components/LayerPanel/DamsLegend', 'js/config', 'stores/MapStore', 'actions/MapActions', 'js/constants', 'react'], function (exports, _WaterStressLegend, _LandCoverLegend, _RSPOLegend, _SedimentLegend, _DensityDisplay, _LayerCheckbox, _FiresControls, _FireHistoryTimeline, _ForestControls, _RiskControls, _PlantationControls, _ViirsControls, _ArchiveControls, _NoaaControls, _BurnScarsLegend, _RainControls, _AirControls, _WindControls, _LayerTransparency, _ImageryComponent, _LayerGroup, _DamsLegend, _config, _MapStore, _MapActions, _constants, _react) {
  'use strict';
  ...
  var _RSPOLegend2 = _interopRequireDefault(_RSPOLegend);
        ...
        return function (layer) {
          ...
          switch (layer.id) {
            ...
            case _constants2.default.rspoOilPalm:
              childComponent = _react2.default.createElement(_RSPOLegend2.default, { url: layer.url, layerIds: layer.layerIds });
              break;
