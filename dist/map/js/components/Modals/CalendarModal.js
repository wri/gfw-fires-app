define(['exports', 'components/Modals/CalendarWrapper', 'stores/MapStore', 'actions/MapActions', 'actions/ModalActions', 'js/config', 'react'], function (exports, _CalendarWrapper, _MapStore, _MapActions, _ModalActions, _config, _react) {
	'use strict';
	...
	var CalendarModal = function (_React$Component) {
		_inherits(CalendarModal, _React$Component);
