! function(s, e) {
    ...
    function t() {
        s.dojoConfig = d, p(o);
        for (var e = r[a], t = 0, c = e.length; c > t; t++) u(e[t].src, e[t].cdn);
        l("app/images/favicon.ico")
    }
    var c, n = c || document.location.pathname.replace(/\/[^/]+$/, "");
    "/" !== n.slice(-1) && (n += "/");
    var a = "dev",
        i = "0.7.6",
        o = "http://js.arcgis.com/3.13/init.js",
        r = {
            dev: [{
        ...
        p = function(s, t) {
            ...
            for (var a in t) t.hasOwnProperty(a) && c.setAttribute(a, t[a]);
            n.appendChild(c)
        },
        u = function(s, t) {
            ...
            c.setAttribute("rel", "stylesheet"), c.setAttribute("type", "text/css"), c.setAttribute("href", n), c.media = "only x", a.appendChild(c), setTimeout(function() {
                c.media = "all"
            })
        },
        l = function(s) {
            ...
            t.setAttribute("rel", "shortcut icon"), t.setAttribute("type", "image/png"), t.setAttribute("href", s), c.appendChild(t), setTimeout(function() {
                t.media = "all"
            })
        };
