...
define([
...
], function(dom, arrayUtils, on, dojoQuery, Deferred, all, xhr, domAttr, keys, FeatureLayer, Graphic,
    Point, webMercatorUtils, PictureSymbol, InfoTemplate, MainConfig, MapConfig, MapModel, LayerController, IdentifyTask,
    ...
    return {
        ...
        mapClick: function(event) {
            ...
            // isVisLayers = overlaysLayer.visibleLayers.indexOf(1) > -1 || overlaysLayer.visibleLayers.indexOf(2) > -1 || overlaysLayer.visibleLayers.indexOf(3) > -1 || overlaysLayer.visibleLayers.indexOf(4) > -1 || forestUseLayer.visibleLayers.indexOf(10) > -1 || conservationLayers.visibleLayers.indexOf(25) || conservationLayers.visibleLayers.indexOf(16) || forestUseLayer.visibleLayers.indexOf(26) > -1 || forestUseLayer.visibleLayers.indexOf(27) > -1 || forestUseLayer.visibleLayers.indexOf(28) > -1 || forestUseLayer.visibleLayers.indexOf(32) > -1,
            ...
            //     visLayers.push(lid);
            // });
            // arrayUtils.forEach(overlaysLayer.visibleLayers, function(lid) {
            //     visLayers.push(lid);
            // });

            // // if (conservationLayers.visible) {
            // //     visLayers.push(25);
            // // } //dp the same check for 16 Annnd for all of the overlay layers!
            ...
            //                 //if (node.layerId === 10 || node.layerId === 25 || node.layerId === 28 || node.layerId == 27 || node.layerId == 32) {
            //                 if ([10, 25, 27, 28, 32].indexOf(node.layerId) > -1) {
            //                     content += "<br /><div id='uploadCustomGraphic' class='uploadCustomGraphic' style='position: relative;margin-top: 0px;margin-left: 10px;width: 77px;'>Subscribe</div>";
            //                 }
            ...
            //                 handleSubscribe = on.once(dom.byId('uploadCustomGraphic'), 'click', function(feature) {
            //                     var geom = node.feature;
            //                     geom.attributes.ALERTS_LABEL = geom.attributes.NAME;
