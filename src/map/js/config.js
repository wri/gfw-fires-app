...
export const config = {
  map: {
    ...
    customBasemap: {
      url:
        'https://api.tiles.mapbox.com/v4/wri.c974eefc/${level}/${col}/${row}.png?access_token=pk.eyJ1Ijoid3JpIiwiYSI6IjU3NWNiNGI4Njc4ODk4MmIyODFkYmJmM2NhNDgxMWJjIn0.v1tciCeBElMdpnrikGDrPg',
      options: {
        id: KEYS.wriBasemap,
        visible: false
      }
    ...
    geometryServiceUrl:
      'https://gis-gfw.wri.org/arcgis/rest/services/Utilities/Geometry/GeometryServer'
  },
  ...
  upload: {
    ...
    infoTemplate: {
      content:
        '<table><tr><td>Name: </td><td>${featureName}</td></tr></table>' +
  ...
  layers: [
    {
      ...
      group: 'fires', // Determines if the layer is to be included in the left panel.
      visible: true,
      layerIds: [21],
...

    {
      ...
      defaultDefinitionExpression:
        "ACQ_DATE < date'" +
        new window.Kalendae.moment().subtract(1, 'w').format('M/D/YYYY') +
        "' AND ACQ_DATE > date'" +
        new window.Kalendae.moment().subtract(2, 'w').format('M/D/YYYY') +
        "'",
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_ASEAN/MapServer',
    ...
    },
    {
      ...
      defaultDefinitionExpression:
        "Date < date'" +
        new window.Kalendae.moment().format('M/D/YYYY') +
        "' AND Date > date'" +
        new window.Kalendae.moment().subtract(1, 'w').format('M/D/YYYY') +
        "'",
      url:
      ...
      infoTemplate: {
        content:
          '<table><tr><td class="field-name">DATE: </td><td class="field-value">${Date}</td></tr>' +
    ...
    },
    {
      ...
      infoTemplate: {
        content:
          '<table><span class="name-field">${type_}</span></tr>' +
    ...
    },
    {
      ...
      url:
        'https://gfw-staging.wri.org/arcgis/rest/services/image_services/idn_annual_fire_frequency/ImageServer',
    ...
    },
    {
      ...
      // disabled: true,
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/image_services/fire_risk_pantropics/ImageServer',
    ...
    },
    {
      ...
      // disabled: true,
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/image_services/DSLR_pantropics/ImageServer',
    ...
    },
    {
      ...
      infoTemplate: {
        content:
          '<table><span class="name-field">${Name}</span></tr>' +
    ...
    },
    {
      ...
      className: 'rspo-palm',
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/commodities/MapServer/',
...

    {
      ...
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/partner_requests/greenpeace_en/MapServer',
      metadataId: 'idn_oilpalm_greenpeace',
      layerIds: [0],
      infoTemplate: {
        content:
          '<table><tr><td>CONCESSION HOLDER: </td><td>${Consession Holder}</td></tr>' +
    ...
    },
    {
      ...
      infoTemplate: {
        content:
          '<table><tr><td>CONCESSION HOLDER: </td><td>${coal_com}</td></tr>' +
          '<tr><td>GROUP: </td><td>${Group}</td></tr>' +
          '<tr><td>AREA (ha): </td><td>${Area (ha):NumberFormat(places:0)}</td></tr>' +
    ...
    },
    {
      ...
      url:
        'https://gis-treecover.wri.org/arcgis/rest/services/TreeCover2000/ImageServer',
    ...
    },
    {
      ...
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/Fires/primary_forest_2000to2012/MapServer',
    ...
    },
    {
      ...
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/Fires/OpenAQI/MapServer',
    ...
    },
    {
      ...
      url:
        'https://gis-gfw.wri.org/arcgis/rest/services/Fires/GFED_2015_Emissions/MapServer',
    ...
    },
    {
      ...
      Districts: {
        infoTemplate: {
          content:
            '<table><span class="name-field">${DISTRICT}</span></tr>' +
      ...
      Subdistricts: {
        infoTemplate: {
          content:
            '<table><span class="name-field">${SUBDISTRIC}</span></tr>' +
    ...
    },
    {
      ...
      className: 'tree-cover',
      url:
        'https://landsat.arcgis.com/arcgis/rest/services/Landsat8_PanSharpened/ImageServer',
      metadataId: 'latest_landsat'
    },
    {
      ...
      imageServices: [
        {
          id: 'dg-00',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/WV01/ImageServer',
          mosaic: 'WV01'
        },
        {
          id: 'dg-01',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/QB01/ImageServer',
          mosaic: 'QB01'
        },
        {
          id: 'dg-02',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/WV02/ImageServer',
          mosaic: 'WV02'
        },
        {
          id: 'dg-03',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/GE01/ImageServer',
          mosaic: 'GEO1'
        },
        {
          id: 'dg-04',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/WV03/ImageServer',
          mosaic: 'WV03'
        },
        {
          id: 'dg-05',
          url:
            'https://gis-gfw.wri.org/arcgis/rest/services/image_services/WV03_SWIR/ImageServer',
          mosaic: 'WV03_SWIR'
        }
      ],
      type: 'image',
    ...
    },
    {
      ...
      infoTemplate:
        app.mobile() === true
          ? {
              content:
                '<table class="fire-stories-popup mobile"><span class="name-field">${Title}</span></tr>' +
          ...
          : {
              content:
                '<table class="fire-stories-popup"><span class="name-field">${Title}</span></tr>' +
                '<tr><td class="field-value wide">${Details}</td></tr>' +
                '<tr><td class="field-value wide"><a href="${Video}" target="_blank">Video</a></td></tr>' +
                '<tr><td class="field-value wide">${Date}</td></tr>'
            }
  ...
  symbol: {
    ...
    pointUrl:
      'https://js.arcgis.com/3.14/esri/dijit/Search/images/search-pointer.png'
  },
  ...
  analysis: {
    ...
    requests: {
      countries: {
        url:
          'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS/MapServer/3/query?returnDistinctValues=true&f=json&where=1%3D1&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=NAME_0',
        callback: 'callback'
      },
      adm1: {
        url:
          'https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS/MapServer/3/query?returnDistinctValues=true&f=json&where=1%3D1&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=NAME_0,NAME_1',
        callback: 'callback'
      }
    }
  },
  ...
  text: {
    ...
    errors: {
      missingLayerConfig:
        'You provided a layer config containing a url but not a type, please specify the layer type in the layer config.',
      incorrectLayerConfig: type =>
        `You provided an invalid type, the application is not configured for type: ${type}. Please use the correct type or implement it in the LayerFactory.`,
      geolocationUnavailable:
        'Sorry, it looks like your browser does not support geolocation, please try the latest versions of Safari, Chrome, or Firefox.',
      geolocationFailure: message =>
        `Error retrieving location at this time. ${message}`,
      featureNotFound:
    ...
    analysisPanel: {
      ...
      analysisDateRangeErrorMessage:
        'Fire report is available for the last 12 months',
      ...
      drawingDisclaimer:
        'Maximum fires returned are 5,000. Reduce the size of your shape or the time range to refine your analysis.',
      subscriptionInstructionsOne:
        'Draw or upload a shape to calculate fire counts and subscribe to alerts.',
      ...
      subscriptionClick:
        'Click on drawn or uploaded shapes on the map to subscribe to the area.',
    ...
    modals: {
      ...
      alerts: {
        ...
        messages: {
          formaSuccess:
            'Thank you for subscribing to Forma Alerts.\nYou should receive a confirmation email soon.',
          formaFail:
            'There was an error with your request to subscribe to Forma alerts.\rPlease try again later.',
          fireSuccess:
            'Thank you for subscribing to Fires Alerts.\rYou should receive a confirmation email soon.',
          fireFail:
            'There was an error with your request to subscribe to Fires alerts.\rPlease try again later.'
        }
      },
      canopy: {
        title:
      ...
      subscription: {
        ...
        emailInstructions:
          'Enter your email(s) below to receive fire alerts. Multiple emails must be separated by commas.',
        ...
        emailConfirmation:
          'Your request has been received. Please check your email for a confirmation message with a link to complete the subscription process.',
        phoneConfirmation:
          'Your request has been received. A confirmation message will be sent to your phone.',
        ...
        successMessage:
          'You have successfully subscribed. You will receive an email asking you to verify your subscription. Please be sure to check your SPAM folder. Once verified, you will start receiving alerts for your area.',
    ...
    metadataIds: {
      ...
      'forest-and-land-cover-intact-forest-landscape':
      ...
      'forest-and-land-cover-land-cover-south-east-asia':
...
config.text.layerInformation[KEYS.treeCoverDensity] = {
  ...
  table: [
    ...
    { label: 'Resolution/Scale', html: '30 × 30 meters' },
    {
      ...
      html: 'Global land (excluding Antarctica and Arctic islands)'
    },
    {
      label: 'Source Data',
      html:
        '<a href="https://landsat.usgs.gov/" target="_blank">Landsat 7 ETM+</a>'
    },
...
config.text.layerInformation[KEYS.activeFires] = {
  ...
  table: [
    ...
    { label: 'Geographic Coverage', html: 'Global' },
    {
      label: 'Source Data',
      html:
        '<a href="https://modis.gsfc.nasa.gov/about/" target="_blank">MODIS</a>'
    },
...
config.text.layerInformation[KEYS.burnScars] = {
  ...
  table: [
    {
      label: 'Function',
      html: 'Provides an estimate of the extent of land burned by fire'
    },
    ...
    { label: 'Geographic Coverage', html: 'Sumatra, Indonesia' },
    {
      label: 'Source Data',
      html:
        '<a href="https://landsat.usgs.gov/index.php" target="_blank">Landsat</a>'
    },
    { label: 'Date of Content', html: 'May 1, 2014 - present' },
    {
      label: 'Cautions',
      html:
        'This data layer is provided as a beta analysis product and should be used for visual purposes only.'
    }
  ],
  overview: [
