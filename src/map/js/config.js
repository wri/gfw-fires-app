  ...
  layers: [
    ...
    },
    {
      ...
      infoTemplate: {
        ...
        '<tr><td class="field-name thin">Details: </td><td class="field-value wide">${Details}</td></tr>' +
        '<tr><td class="field-name thin">Date: </td><td class="field-value wide">${Date}</td></tr>'
      }
    },
    {
      id: KEYS.twitter,
