    ...
    if (archiveLayer) {
      ...
      archiveLayer.layerDrawingOptions[0] =
        archiveLayer.layerDrawingOptions[
          layersConfig.filter(index => index.id === 'viirsFires')[0].layerIds[0]
        ];
      let string =
        "ACQ_DATE <= date'" +
        new window.Kalendae.moment(clauseArray[1]).format('M/D/YYYY') +
        ...
        new window.Kalendae.moment(clauseArray[0]).format('M/D/YYYY') +
        "'";
      archiveLayer.dynamicLayerInfos[shortTermServices.viirs1YR.id].id =
        shortTermServices.viirs1YR.id;
      archiveLayer.dynamicLayerInfos[
        shortTermServices.viirs1YR.id
      ].source.mapLayerId = shortTermServices.viirs1YR.id;
      archiveLayer.dynamicLayerInfos[
        shortTermServices.viirs1YR.id
