module.exports = {
    ...
    },
    {
        ...
        "gcr": "Democratic Republic of the Congo",
        "Alpha-2 code": "CD",
        "Alpha-3 code": "COD",
        "Numeric": 180
    },
    ...
    },
    {
        ...
        "gcr": "French Southern Territories",
        "Alpha-2 code": "TF",
        "Alpha-3 code": "ATF",
        "Numeric": 260
    },
    ...
    },
    {
        ...
        "French short name": "Lao, République démocratique populaire",
        "gcr": "Laos",
        "Alpha-2 code": "LA",
        "Alpha-3 code": "LAO",
        "Numeric": 418
    ...
    },
    {
        ...
        "French short name": "Moldova, République de",
        "gcr": "Moldova",
        "Alpha-2 code": "MD",
        "Alpha-3 code": "MDA",
        "Numeric": 498
    ...
    },
    {
        ...
        "gcr": "United Arab Emirates",
        "Alpha-2 code": "AE",
        "Alpha-3 code": "ARE",
        "Numeric": 784
    },
    {
        "English short name": "United Kingdom of Great Britain and Northern Ireland (the)",
        "French short name": "Royaume-Uni de Grande-Bretagne et d'Irlande du Nord (le)",
        "gcr": "United Kingdom",
        "Alpha-2 code": "GB",
        "Alpha-3 code": "GBR",
        "Numeric": 826
    },
    {
        ...
        "gcr": "United States Minor Outlying Islands",
        "Alpha-2 code": "UM",
        "Alpha-3 code": "UMI",
        "Numeric": 581
    },
    ...
    firesLayer: {
        ...
        viirs: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_short_term/MapServer/',
        modis: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_short_term/MapServer',
        global_viirs: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_VIIRS_short_term/MapServer/20',
        global_modis: 'https://gfw-staging.wri.org/arcgis/rest/services/Fires/FIRMS_Global_MODIS_short_term/MapServer/13',
        admin_service: 'https://gis-gfw.wri.org/arcgis/rest/services/admin/MapServer',
        id: "Active_Fires",
        fire_id: 0,
        fire_id_global_viirs: 20,
        fire_id_global_modis: 13,
        fire_id_all_viirs: 20,
        fire_id_all_modis: 13,
    ...
    adminBoundary: {
        ...
        urlIsland: "https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_ASEAN/MapServer",
        urlGlobal: "https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global/MapServer",
        urlAll: "https://gis-gfw.wri.org/arcgis/rest/services/Fires/FIRMS_Global/MapServer",
        id: 'district-bounds',
        defaultLayers: [6],
        defaultLayersGlobal: [5],
        defaultLayersAll: [6],
        UniqueValueField: 'DISTRICT',
        UniqueValueFieldGlobal: 'NAME_1',
        UniqueValueFieldAll: 'NAME_0',
        UniqueValueFieldAlliso: 'iso',
        UniqueValueFieldAllEnglish: 'NAME_ENGLISH',
        regionField: 'PROVINCE',
        regionFieldGlobal: 'NAME_1',
        regionFieldAll: 'NAME_ENGLISH',
        layerId: 6,
        layerIdGlobal: 5,
        layerIdAll: 6,
        where: "fire_count > 0",
    ...
    subdistrictBoundary: {
        ...
        UniqueValueFieldAllEnglish: 'NAME_1',
    ...
    subDistrictQuery: {
        ...
        outFieldsAll: ['NAME_1', 'NAME_0', 'fire_count'],
